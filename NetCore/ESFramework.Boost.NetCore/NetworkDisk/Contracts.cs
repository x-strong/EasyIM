...
namespace ESFramework.Boost.NetworkDisk
{
  ...
  {
    public CopyContract() { }
    public CopyContract(string netDiskID, string sourceParentDirectoryPath, IList<string> filesBeCopyed, IList<string> directoriesBeCopyed, string destParentDirectoryPath)
    {
      _netDiskID = netDiskID;
      this._sourceParentDirectoryPath = sourceParentDirectoryPath;
      this._filesBeCopyed = filesBeCopyed;
      this._directoriesBeCopyed = directoriesBeCopyed;
      this._destParentDirectoryPath = destParentDirectoryPath;
    }

    #region NetDiskID
    private string _netDiskID;
    /// <summary>
    /// 要访问的网络磁盘的ID。
    /// </summary>
    public string NetDiskID
    {
      get { return _netDiskID; }
      set { _netDiskID = value; }
    }
    #endregion

    #region SourceParentDirectoryPath
    private string _sourceParentDirectoryPath;
    public string SourceParentDirectoryPath
    {
      get { return _sourceParentDirectoryPath; }
      set { _sourceParentDirectoryPath = value; }
    }
    #endregion

    #region DirectoriesBeCopyed
    private IList<string> _directoriesBeCopyed;
    public IList<string> DirectoriesBeCopyed
    {
      get { return _directoriesBeCopyed; }
      set { _directoriesBeCopyed = value; }
    }

    #endregion

    #region FilesBeCopyed
    private IList<string> _filesBeCopyed = new List<string>();
    public IList<string> FilesBeCopyed
    {
      get { return _filesBeCopyed; }
      set { _filesBeCopyed = value; }
    }
    #endregion

    #region DestParentDirectoryPath
    private string _destParentDirectoryPath;
    public string DestParentDirectoryPath
    {
      get { return _destParentDirectoryPath; }
      set { _destParentDirectoryPath = value; }
    }
    #endregion
  }
