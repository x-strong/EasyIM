...
namespace EasyIM.Linux
{
    internal class CommonBusinessMethod
    {
        ...
        internal async static void AddFriend(Window parentWindow, ResourceCenter<IMUser, IMGroup> resourceCenter,string userID)
        {
            IMUser friend = resourceCenter.ClientGlobalCache.GetUser(userID);
