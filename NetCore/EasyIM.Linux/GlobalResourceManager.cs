    ...
    internal class GlobalResourceManager
    {
        public static void Initialize()
        {
            try
            {
                ...
                statusImageDictionary.Add(UserStatus.Online, EasyIM.Linux.Helpers.FileHelper.FindAssetsBitmap("0.png"));
                statusImageDictionary.Add(UserStatus.Away, EasyIM.Linux.Helpers.FileHelper.FindAssetsBitmap("1.png"));
                statusImageDictionary.Add(UserStatus.Busy, EasyIM.Linux.Helpers.FileHelper.FindAssetsBitmap("2.png"));
                statusImageDictionary.Add(UserStatus.DontDisturb, EasyIM.Linux.Helpers.FileHelper.FindAssetsBitmap("3.png"));
                statusImageDictionary.Add(UserStatus.Hide, EasyIM.Linux.Helpers.FileHelper.FindAssetsBitmap("4.png"));
                statusImageDictionary.Add(UserStatus.OffLine, EasyIM.Linux.Helpers.FileHelper.FindAssetsBitmap("5.png"));
        ...
        public static Bitmap FileAssistantImage
        {
            ...
            {
                return null;
                //return global::EasyIM.Properties.Resources.FileAssistant;
            }
        } 
        #endregion
        ...
        private static IIMService remotingService;
        public static IIMService RemotingService
        {
        ...
        public static Image GetHeadImage(IMUser user)
        {
            return GlobalResourceManager.GetHeadImage(user, false);
        }

        public static Image GetHeadImageOnline(IMUser user)
        {
        ...
        public static Image GetHeadImage(IMUser user, bool mine)
        {
            if (user.HeadImageIndex >= 0)
            {
