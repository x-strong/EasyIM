    ...
    internal class GroupItem : TreeViewItem
    {
        ...
        { 
            ...
            Children.Add(new TextBlock
            {
                ...
                Bindings =
                {
                    {nameof(TextBlock.Text),nameof(IMGroup.DisplayName) },
                    {
                        nameof(Width),
                        nameof(ActualSize),
                        1,
            ...
            Children.Add(new TextBlock
            {
                ...
                Bindings =
                {
                    {nameof(TextBlock.Text),nameof(IMGroup.MemberCount),null,BindingMode.OneWay, x=>x+"人"}
                }
            });
            Children.Add(new TextBlock
            {
                ...
                Bindings =
                {
                    {nameof(TextBlock.Text),nameof(IMGroup.CreateTime),null,BindingMode.OneWay,x=>((DateTime)x).ToShortDateString()  }
                }
            });
