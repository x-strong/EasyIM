    ...
    internal class UserItem : TreeViewItem
    {
        protected override void InitializeComponent()
        {
            ...
            Children.Add(new Picture
            {
                ...
                Bindings =
                {
                    {nameof(Picture.Source),nameof(IMUserPlus.HeadImage) }
                }
            });
            ...
            Children.Add(new Picture
            {
                ...
                Bindings =
                {
                    {nameof(Picture.Source),nameof(IMUserPlus.UserStatus),null,BindingMode.OneWay, a =>{
                        UserStatus userStatus= (UserStatus)a ;
                        if(userStatus==UserStatus.Hide&&Program.ResourceCenter.CurrentUserID!=((IMUserPlus)this.DataContext).ID)
                        {
            ...
            Children.Add(new TextBlock
            {
                ...
                Bindings =
                {
                    {nameof(TextBlock.Text),nameof(IMUserPlus.DisplayName) },
                    {
                        nameof(Width),
                        nameof(ActualSize),
                        1,
            ...
            Children.Add(new TextBlock
            {
                ...
                Bindings =
                {
                    {nameof(TextBlock.Text),nameof(IMUserPlus.Signature) },
                    {
                        nameof(Width),
                        nameof(ActualSize),
                        1,
