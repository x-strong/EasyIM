...
namespace EasyIM.Linux.Controls
{
    internal class FileTransferItem : Control
    {
        ...
        public void Initialize(TransferingProject info, bool offlineFile, bool doneAgreed, Window _parentWindow)
        {
            ...
            this.pic_transferType.Source = info.IsFolder ? EasyIM.Linux.Helpers.FileHelper.FindAssetsBitmap("wenjianjia.png") : EasyIM.Linux.Helpers.FileHelper.GetFileIconBitmap(info.ProjectName);
        ...
        public async void GetPathToSave(string title, string defaultName)
        {
            ...
            Task<string> task = needOpenFolderDialog ? EasyIM.Linux.Helpers.FileHelper.OpenFolderDialog(this.parentWindow, title) : EasyIM.Linux.Helpers.FileHelper.SaveFileDialog(this.parentWindow, title, defaultName);
