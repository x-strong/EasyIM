...
namespace EasyIM.Linux.Controls
{
    internal class NotifyItemPanel2 : ListBoxItem
    {
        ...
        private void Image_head_MouseDown(object sender, CPF.Input.MouseButtonEventArgs e)
        {
            ...
            {
                IMUser friend = Program.ResourceCenter.ClientGlobalCache.GetUser(this.friendID);
            ...
            {
                IMGroup group = Program.ResourceCenter.ClientGlobalCache.GetGroup(this.groupID);
                if (group == null) { return; }
                GroupInfoWindow groupInfoWindow = new GroupInfoWindow(group);
        ...
        private void InitializeView()
        {
            ...
            if (model.NotifyType == NotifyType.Group)
            {
                ...
                IMGroup group = Program.ResourceCenter.ClientGlobalCache.GetGroup(model.GroupID);
