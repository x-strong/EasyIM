...
{
    internal class FriendChatWindow:Window, IFriendChatForm<IMUser>
    {
        private bool init;
                                ...
                                Children =
                                {
                                    new Button
                                    {
                                        ...
                                        Content = new Picture
                                        {
                                            ...
                                            Bindings={ { nameof(Picture.Source),nameof(IMUserPlus.HeadImage)} }                                           
                                        },
                                    ...
                                    new TextBlock
                                    {
                                        ...
                                        Name = "NickName",
                                        FontSize = 20,
                                        Bindings={ { nameof(TextBlock.Text),nameof(IMUserPlus.DisplayName)} }
                                    },
                                    new TextBlock
                                    {
                                        MarginLeft = 81,
                            ...
                            new Panel
                            {
                                ...
                                Children =
                                {
                                    ...
                                    new TextBlock
                                    {
                                        ...
                                        Text = "账号：10003",
                                        FontSize = 13,
                                        Bindings={ { nameof(TextBlock.Text),nameof(IMUserPlus.ID), null, BindingMode.OneWay, x => "账号："+x } }
                                    },
                                    new TextBlock
                                    {
                                        MarginLeft = 31,
                                        ...
                                        Text = "名称：李建平",
                                        FontSize = 13,
                                        Bindings={ { nameof(TextBlock.Text),nameof(IMUserPlus.Name), null, BindingMode.OneWay, x => "名称：" + x } }
                                    },
                                },
                                Attacheds =
                                {
        ...
        #region IFriendChatForm<User>

        public string UnitID => this.currentFriend.ID;

        public void FriendInfoChanged(IMUser user)
        {
            if (user.ID != this.currentFriend.ID) { return; }
            this.currentFriend = user;
            IMUserPlus userPlus = new IMUserPlus(this.currentFriend);
        ...
        public void MyInfoChanged(IMUser my)
        {
