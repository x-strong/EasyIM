...
namespace EasyIM.Linux.Views
{
    ...
    {
        private Collection<IMUserPlus> list = new Collection<IMUserPlus>();
        ...
        public GroupInfoWindow(IMGroup _group)
        {
            this.groupDetailUserListModel.UserList = new Collection<IMUserPlus>();
            InitializeComponent();
                                                ...
                                                new GroupDetailListBox
                                                {
                                                    ...
                                                    ItemTemplate = new GroupDetailListBoxItem(){
                                                        Commands={ { nameof(DoubleClick),(s,e)=> {
                                                            ...
                                                            IMUser user= s.DataContext as IMUser;
                                                            if(user==null){ return; }
                                                            this.UserPanelControl_DoubleClicked(user);
        ...
        private void InitMemberList()
        {
            ...
            {
                IMUser user = Program.ResourceCenter.ClientGlobalCache.GetUser(memberID);
                this.groupDetailUserListModel.UserList.Add(new IMUserPlus(user));
            }
            this.DataContext = this.groupDetailUserListModel;
        }

        private void UserPanelControl_DoubleClicked(IMUser user)
        {
            if (user == null) { return; }
