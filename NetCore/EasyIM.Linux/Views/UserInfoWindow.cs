...
namespace EasyIM.Linux.Views
{
    internal class UserInfoWindow : BaseWindow
    {
        ...
        private IMUserPlus userPlus;
        private bool isFriend = false;
        public UserInfoWindow(IMUser user)
        {
            this.userPlus = new IMUserPlus(user);
            this.isFriend = Program.ResourceCenter.ClientGlobalCache.CurrentUser.IsFriend(user.ID);
            this.DataContext = this.userPlus;
            this.InitializeComponent();
            this.SetRemarkBtn(this.userPlus.CommentName);
        }
                    ...
                    new Panel
                    {
                        ...
                        Children =
                        {
                            new Picture
                            {
                                ...
                                Width = 100,
                                Height = 100,
                                Bindings={ { nameof(Picture.Source),nameof(userPlus.HeadImage)} }
                            },
                            new Button
                            {
                            ...
                            new TextBlock
                            {
                                ...
                                Text = "123456",
                                FontSize = 14,
                                Bindings={ { nameof(TextBlock.Text),nameof(userPlus.ID)} }
                            },
                            new TextBlock
                            {
                                MarginLeft = 145,
                            ...
                            new TextBlock
                            {
                                ...
                                Text = "哦哦哦",
                                FontSize = 14,
                                Bindings={ { nameof(TextBlock.Text),nameof(userPlus.Name)} }
                            },
                            new TextBlock
                            {
                                MarginBottom = 131,
                            ...
                            new TextBlock
                            {
                                ...
                                Text = "2021-01-09",
                                FontSize = 14,
                                Bindings={ { nameof(TextBlock.Text),nameof(userPlus.CreateTime)} }
                            },
                            new TextBlock
                            {
                                MarginBottom = 101,
                            ...
                            new TextBox
                            {
                                ...
                                BorderThickness = new Thickness(1, 1, 1, 1),
                                BorderType = BorderType.BorderThickness,
                                Bindings={ { nameof(TextBox.Text),nameof(userPlus.Signature)} }
                            }
                        }
                    }
                }
        ...
        private void Btn_send_Click(object sender, RoutedEventArgs e)
        {
            if (this.isFriend)
            {
                CommonHelper.MoveToChat(this.userPlus);
            }
            else {
                CommonBusinessMethod.AddFriend(this, Program.ResourceCenter, this.userPlus.ID);
            }
        }
        ...
        {
            string oldName = this.btn_remark2.Visibility == Visibility.Visible ? this.btn_remark2.Text : this.userPlus.CommentName;
            ...
            {
                Program.ResourceCenter.ClientOutter.ChangeUnitCommentName(this.userPlus.ID, form.NewName);
