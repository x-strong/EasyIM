...
{
    internal class GroupChatWindow : Window, IGroupChatForm<IMUser>
    {
                            ...
                            new Grid
                            {
                                ...
                                Children =
                                {
                                    ...
                                    new TextBlock
                                    {
                                        ...
                                        Name = "GroupName",
                                        FontSize = 20,
                                        Bindings={ { nameof(TextBlock.Text),nameof(IMGroup.Name) } },
                                    ...
                                    //    Name = "CreationDate",
                                    //    FontSize = 18,
                                    //    Bindings={ { nameof(TextBlock.Text),nameof(IMGroup.CreateTime),null,BindingMode.OneWay, x=> ((DateTime)x).ToString("d") } }
                                    //},
                                    new TextBlock
                                    {
                                        MarginLeft = 81,
                                        ...
                                        Name = "notice",
                                        FontSize = 12,
                                        Bindings={ { nameof(TextBlock.Text),nameof(IMGroup.Announce) } }
                                    },
                                    new Panel
                                    {
                                        MarginRight = 80f,
        ...
        public void HandleBePulledIntoGroupNotify(string operatorUserID)
        {
            ...
            IMUser user = Program.ResourceCenter.ClientGlobalCache.GetUser(operatorUserID);
        ...
        {
            IMUser user = Program.ResourceCenter.ClientGlobalCache.GetUser(userID);
            this.userInGroupBox.AddUser(new IMUserPlus(user));
        ...
        {
            this.userInGroupBox.UpdateUser((IMUser)unit);
        }
        #endregion
