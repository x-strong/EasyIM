...
namespace TalkBase.Client
{
        ...
        where TGroup : TalkBase.IGroup, new()
    {
        ...
        //    EasyIM.Linux.Controls.ChatBoxContent2 chatBoxContent = new EasyIM.Linux.Controls.ChatBoxContent2("[语音消息]", SystemSettings.DefaultSimpleFont, System.Drawing.Color.Black);
