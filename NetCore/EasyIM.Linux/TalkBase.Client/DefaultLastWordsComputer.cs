...
namespace TalkBase.NetCore.Client
{
        ...
        where TGroup : TalkBase.IGroup, new()
    {
        ...
        public string GetLastWords(IUnit unit)
        {
            ...
            EasyIM.Linux.Controls.ChatBoxContent2 chatBoxContent = ESPlus.Serialization.CompactPropertySerializer.Default.Deserialize<EasyIM.Linux.Controls.ChatBoxContent2>(unit.LastWordsRecord.ChatContent, 0);
