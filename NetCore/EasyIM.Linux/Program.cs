...
namespace EasyIM.Linux
{
    internal class Program
    {
        ...
        private static ResourceCenter<IMUser, IMGroup> resourceCenter;
        internal static ResourceCenter<IMUser, IMGroup> ResourceCenter => resourceCenter;
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                resourceCenter = new ResourceCenter<IMUser, IMGroup>();
