...
namespace EasyIM.Controls
{
    public partial class FriendChatPanel : FlatBasePanel, IFriendChatForm, IOwnerForm
    {
        ...
        private RemoteDiskManager<IMUser, IMGroup> remoteDiskManager;
        private RemoteDesktopManager<IMUser, IMGroup> remoteDesktopManager;
        ...
        private IMUser currentFriend;
        public event CbGeneric<string> VibrationNeeded;
        private bool isInHisBlackList = false;//是否在对方的黑名单中

        #region Ctor
        public FriendChatPanel(ResourceCenter<IMUser, IMGroup> center, string friendID)
        {
            this.resourceCenter = center;
            this.currentFriend = this.resourceCenter.ClientGlobalCache.GetUser(friendID);
            this.remoteDiskManager = new RemoteDiskManager<IMUser, IMGroup>(this.resourceCenter, this, this.currentFriend);
            this.remoteDesktopManager = new RemoteDesktopManager<IMUser, IMGroup>(this.resourceCenter, this, this.currentFriend);
            this.audioDialogManager = new AudioDialogManager<IMUser, IMGroup>(this.resourceCenter, this, this.currentFriend);
            this.videoDialogManager = new VideoDialogManager<IMUser, IMGroup>(this.resourceCenter, this, this.currentFriend);
        ...
        {
            IMUser friend = _friend as IMUser;
        ...
        {
            this.FriendInfoChanged((IMUser)unit);
        }
        #endregion
