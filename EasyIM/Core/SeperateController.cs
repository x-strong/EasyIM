...
namespace EasyIM
{
    ...
    /// 非合并模式的聊天窗口控制器。
    /// </summary>
    public class SeperateController : SeperateChatFormController<IMUser, IMGroup>
    {
        public SeperateController(ResourceCenter<IMUser, IMGroup> center, IChatFormShower formShower) :base(center, formShower) 
        {
