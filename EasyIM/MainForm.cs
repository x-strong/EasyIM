...
namespace EasyIM
{
    ...
    public partial class MainForm : BaseForm, IChatSupporter, ITwinkleNotifySupporter, IUnitInfoProvider, IChatFormShower
    {
        ...
        private ChatList2ChatFormBridge<IMUser, IMGroup > chatList2ChatFormBridge;
        ...
        void friendListBox1_ViewInfoClicked(IUnit unit)
        {
            ...
            UserInfoForm form = new UserInfoForm(this.resourceCenter, (IMUser)unit);
            form.Show();
        }
        ...
        /// </summary>
        public void Initialize(ResourceCenter<IMUser, IMGroup> center, UserStatus iniStatus, IDynamicGroupOutter groupOutter)
        {           
            ...
            this.event2ChatFormBridge = new Event2ChatFormBridge<IMUser, IMGroup >(this.resourceCenter, GlobalResourceManager.UiSafeInvoker,this);

            this.toolStripMenuItem4.Visible = false;            
            this.toolStripSplitButton4_ButtonClick(this.toolStripSplitButton4, new EventArgs());

            this.event2ChatListBridge = new Event2ChatListBridge<IMUser, IMGroup >(this.resourceCenter, GlobalResourceManager.UiSafeInvoker, this.twinkleNotifyIcon1, this.friendListBox1, this.groupListBox1, this.recentListBox1);
            this.chatList2ChatFormBridge = new ChatList2ChatFormBridge<IMUser, IMGroup >(this.resourceCenter, this.friendListBox1, this.groupListBox1, this.recentListBox1,this);
        ...
        void do_rapidPassiveEngine_ConnectionInterrupted()
        {
            ...
            foreach (IMUser friend in this.resourceCenter.ClientGlobalCache.GetAllUser())
            {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (string friendID in this.resourceCenter.ClientGlobalCache.CurrentUser.GetAllFriendList()) 
                {
                    ...
                    IMUser friend = this.resourceCenter.ClientGlobalCache.GetUser(friendID);
                    if (friend != null)
                    {
               ...
               foreach (IMGroup group in this.resourceCenter.ClientGlobalCache.GetAllGroups()) 
                {
                    this.groupListBox1.AddGroup(group);                  
                }

                //加载最近联系人
                DefaultLastWordsComputer<IMUser, IMGroup > computer = new DefaultLastWordsComputer<IMUser, IMGroup >(this.resourceCenter);
                int insertIndex = 0;
        ...
        private void ToJoinGroup(string groupID, bool active)
        {
            ...
            IMGroup group = this.resourceCenter.ClientGlobalCache.GetGroup(groupID);
            this.groupListBox1.AddGroup(group);
        ...
        private void ToQuitGroup(IMGroup group, bool active)
        {
        ...
        {
            IMUser user = this.resourceCenter.ClientGlobalCache.GetUser(friendID);
            return user.Name;
        }
        ...
        {
            IMUser user = this.resourceCenter.ClientGlobalCache.GetUser(userID);
        ...
        public Image GetHeadImage(IUnit unit)
        {
            ...
            return GlobalResourceManager.GetHeadImage((IMUser)unit);
        }
