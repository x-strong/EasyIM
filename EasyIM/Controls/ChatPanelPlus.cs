...
namespace EasyIM
{
    ...
    public partial class ChatPanelPlus : UserControl, IUserNameGetter
    {
        ...
        private AudioDialogManager<IMUser, IMGroup> audioDialogManager;
        private VideoDialogManager<IMUser, IMGroup> videoDialogManager;
        ...
        public AudioDialogManager<IMUser, IMGroup> AudioDialogManager { set { this.audioDialogManager = value; this.toolStripButton_Audio.Visible = true; } }
        public VideoDialogManager<IMUser, IMGroup> VideoDialogManager { set { this.videoDialogManager = value; this.toolStripButton_Video.Visible = true; } }
        ...
        public void Initialize(ResourceCenter<IMUser, IMGroup> center, IUnit dest)
        {
            ...
            else if (dest.UnitType == UnitType.Group)
            {
                ...
                this.atSelectUserForm = new AtSelectUserFrom(center, (IMGroup)dest);
        ...
        private void SetHistoryChatMessageRecord(ChatRecordPage page, bool lastPage)
        {
            ...
            for (int i = 0; i < leftCount; i++)
            {
                ...
                IMUser speaker = this.resourceCenter.ClientGlobalCache.GetUser(record.SpeakerID);
        ...
        public void HandleChatMessage(string broadcasterID, ChatBoxContent content, DateTime? originTime, string tag)
        {
            ...
            if (this.destUnit.UnitType == UnitType.Group)
            {
                IMUser user = this.resourceCenter.ClientGlobalCache.GetUser(broadcasterID);
                sender = user;
        ...
        private void AppendChatBoxContent(bool isMe, IMUser sender, DateTime? originTime, ChatBoxContent content,bool scrollToEnd=true)
        {
        ...
        public void OnAudioMessage(OMCS.Passive.ShortMessages.AudioMessage msg, bool myslef)
        {
            ...
            IMUser user = myslef ? this.resourceCenter.ClientGlobalCache.CurrentUser : this.resourceCenter.ClientGlobalCache.GetUser(msg.CreatorID);
            Image headImg = GlobalResourceManager.GetHeadImage(user);
            this.chatBox_history.ChatBoxCore.AppendAudioMessageBox(msg, myslef, headImg,user.DisplayName, DateTime.Now);
            this.ScrollToEnd();
        }
