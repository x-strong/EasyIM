...
namespace EasyIM.Forms
{
    public partial class NotifyItemPanel : UserControl
    {
        ...
        public void Initialize(ResourceCenter<IMUser, IMGroup> center, AddFriendRequest addFriendRequest)
        {
            this.center = center;
            ...
            IMUser friend = this.center.ClientGlobalCache.GetUser(this.friendID);
        ...
        public void Initialize(ResourceCenter<IMUser, IMGroup> center, AddGroupRequest addGroupRequest)
        {
            this.center = center;
            ...
            IMGroup group = this.center.ClientGlobalCache.GetGroup(addGroupRequest.GroupID);
            IMUser friend = this.center.ClientGlobalCache.GetUser(this.friendID);
            this.pictureBox1.Image = GlobalResourceManager.GetHeadImageOnline(friend);
