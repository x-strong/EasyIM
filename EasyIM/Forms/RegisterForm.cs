...
namespace EasyIM
{
    ...
    public partial class RegisterForm : BaseForm
    {
        ...
        private IIMService remotingService;
        ...
        public RegisterForm(IRapidPassiveEngine engine)
        {
            ...
            this.remotingService = (IIMService)Activator.GetObject(typeof(IIMService), string.Format("tcp://{0}:{1}/IMService", ConfigurationManager.AppSettings["ServerIP"], registerPort));
        ...
        private IMUser registeredUser = null;
        public IMUser RegisteredUser
        {
            get
            {
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                IMUser user = new IMUser(userID, pwd, userName, "", this.depID, this.skinTextBox_signature.SkinTxt.Text, this.headImageIndex, "");
                user.Phone = phone;
                if (this.selfPhoto)
                {
