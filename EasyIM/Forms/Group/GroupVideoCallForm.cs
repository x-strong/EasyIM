...
namespace EasyIM
{
    public partial class GroupVideoCallForm : BaseForm,IGroupVideoForm
    {
        ...
        private IMUser requestor;
        private List<string> memberIDList;
        public GroupVideoCallForm(ResourceCenter<IMUser, IMGroup> center ,string groupID, IMUser requestor,List<string> memberIDList)
        {
            InitializeComponent();
        ...
        private void GroupVideoCallForm_Load(object sender, EventArgs e)
        {
            ...
            foreach (string memberID in this.memberIDList)
            {
                ...
                IMUser user= this.resourceCenter.ClientGlobalCache.GetUser(memberID);
                ...
                skinPanel.BackgroundImage=user.GetHeadIcon(GlobalResourceManager.HeadImages).ToBitmap();
