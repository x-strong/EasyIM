...
namespace EasyIM
{
    ...
    public partial class GroupChatForm : BaseForm, IGroupChatForm
    {
        ...
        public GroupChatForm(ResourceCenter<IMUser, IMGroup> center, string groupID)
        {
            ...
            {
                IMUser friend = this.resourceCenter.ClientGlobalCache.GetUser(memberID);
        ...
        private void AddUserItem(IMUser friend)
        {
        ...
        {
            IMUser user = this.resourceCenter.ClientGlobalCache.GetUser(operatorUserID);
        ...
        public void FriendInfoChanged(IUser user)
        {
            ...
            items[0].HeadImage = GlobalResourceManager.GetHeadImage((IMUser)user);
        ...
        {
            subItem.CustomizedImage = isBan ? EasyIM.Properties.Resources.AV_Refuse : null;
        }
        ...
        private void SetGroupBan4User(double minutes)
        {
            ...
            IMUser unit = (IMUser)this.chatListBox1.SelectSubItem.Tag;
        ...
        private void skinButton_allGroupBan_Click(object sender, EventArgs e)
        {
            ...
            if (this.isExistAllGroupBan)
            {
                ...
                if (dialogResult == DialogResult.OK)
                {
                    ...
                    this.isExistAllGroupBan = false;
                    this.skinButton_allGroupBan.Image = EasyIM.Properties.Resources.allGroupBanTurnOn;
            ...
            else
            {
                ...
                if (dialogResult == DialogResult.OK)
                {
                    ...
                    this.isExistAllGroupBan = true;
                    this.skinButton_allGroupBan.Image = EasyIM.Properties.Resources.allGroupBanTurnOff;
