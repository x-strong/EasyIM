    ...
    internal class GlobalResourceManager
    {
        public static void Initialize()
        {
            ...
            {             
                ...
                GlobalResourceManager.noneIcon64 = global::EasyIM.Properties.Resources.Oraycn64;               
                GlobalResourceManager.groupIcon = ImageHelper.ConvertToIcon(global::EasyIM.Properties.Resources.normal_group_40,64);
                GlobalResourceManager.notifyIcon = ImageHelper.ConvertToIcon(global::EasyIM.Properties.Resources.notify, 64);
                ...
                GlobalResourceManager.remotingService = (IIMService)Activator.GetObject(typeof(IIMService), string.Format("tcp://{0}:{1}/IMService", ConfigurationManager.AppSettings["ServerIP"], registerPort));
        ...
        #region SoftwareName
        private static string softwareName = "EasyIM";
