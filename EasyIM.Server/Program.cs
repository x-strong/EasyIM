    ...
    {       
        ...
        static void Main()
        {
            try
            {
                ...
                RemotingConfiguration.Configure("EasyIM.Server.exe.config", false);
                IMService service = new Server.IMService(resourceCenter);
                RemotingServices.Marshal(service, "IMService");
